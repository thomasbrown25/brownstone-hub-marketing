...
export const features5 = [
  {
    ...
    description:
      "We connect your existing tools and platforms with powerful API integrations that keep your business running smoothly.",
    svgPath:
      "M13.5 6.75h2.25a4.5 4.5 0 1 1 0 9H13.5M10.5 17.25H8.25a4.5 4.5 0 1 1 0-9H10.5M8.977 15.023l6.046-6.046",
  },
  {
    title: "Scalable Solutions",
    description:
      "From startups to enterprises, our applications grow with your business, built on modern and reliable technology.",
    svgPath:
      "M4 14l5-5 5 3 5-6",
  },
  {
    ...
    description:
      "We transform your data into easy-to-use dashboards that empower smarter decisions and real results.",
    svgPath:
      "M4 20V10M9 20V4M14 20v-7M19 20v-3",
  },
];
